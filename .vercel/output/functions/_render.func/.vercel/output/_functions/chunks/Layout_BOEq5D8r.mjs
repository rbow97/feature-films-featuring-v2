...
function ListItem({
  ...
  return /* @__PURE__ */ jsx("li", { className: " max-w-[200px] shrink-0 snap-start first:pl-md last:pr-xs", children: /* @__PURE__ */ jsxs(
    "button",
    {
      onClick: () => {
        setTimeout(() => {
      ...
      children: [
        /* @__PURE__ */ jsx("span", { className: "block truncate md:group-hover/list-item:-translate-x-5  md:group-hover/list-item:opacity-0 transition-all duration-500 ease-secondary", children: taggedPerson.name }),
        /* @__PURE__ */ jsx("span", { className: "absolute hidden md:block translate-x-5 md:group-hover/list-item:translate-x-0 transition-all duration-500 ease-secondary md:opacity-0 md:group-hover/list-item:opacity-100 ", children: "Remove?" })
      ]
    }
  ) });
}
...
function TagsSearchButton({
  ...
  return /* @__PURE__ */ jsx(
    "a",
    {
      ...
      children: /* @__PURE__ */ jsx("div", { className: "flex items-center rounded-full bg-primary-lightGrey border border-primary-grey px-sm py-xs md:h-md  w-fit text-sm", children: /* @__PURE__ */ jsx("span", { children: "Search" }) })
    }
  );
}
...
function TagsList() {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between h-fit my-sm z-10 gap-md", children: [
    /* @__PURE__ */ jsx("ul", { className: cx("flex items-center md:gap-xs overflow-auto -mx-6"), children: $taggedPeople.map((taggedPerson) => {
      return /* @__PURE__ */ jsx(
        ListItem,
        {
...
const getPopularPeople = async () => {
  const response = await axios.get(
    `https://api.themoviedb.org/3/person/popular?api_key=${"35596d0ce1799b9e4c7617c1698f94dd"}&language=en-US&page=1`
  ).catch((error) => {
    console.log(error);
  });
...
const getSearchedPeople = async (input) => {
  const response = await axios.get(
    `https://api.themoviedb.org/3/search/person?query=${input}&api_key=${"35596d0ce1799b9e4c7617c1698f94dd"}`
  ).catch((error) => {
    console.log(error);
  });
  return response.data.results;
...
const getCreditsPerPerson = async (id) => {
  const response = await axios.get(
    `https://api.themoviedb.org/3/person/${id}/combined_credits?api_key=${"35596d0ce1799b9e4c7617c1698f94dd"}&language=en-US`
  ).catch((error) => {
    console.log(error);
  });
...
export { $$Layout as $, getSearchedPeople as a, getCreditsPerPerson as g, handleRemoveFromTags as h, taggedPeople as t };
