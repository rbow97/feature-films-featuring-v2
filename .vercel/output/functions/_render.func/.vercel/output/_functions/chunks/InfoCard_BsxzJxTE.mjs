...
function InfoCard(props) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "col-span-1 w-full relative mx-auto", children: /* @__PURE__ */ jsxs("article", { className: " max-h-[400px] h-full flex flex-col", children: [
    /* @__PURE__ */ jsx(
      "img",
      {
        loading: "lazy",
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between mt-xs gap-xs w-full", children: [
      /* @__PURE__ */ jsx("p", { className: "text-md text-primary-darkGrey grow truncate max-w-[300px] md:max-w-[unset]", children: title }),
      /* @__PURE__ */ jsxs("div", { className: "flex gap-4 items-start", children: [
        handleTagButtonClick && /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsx("p", { children: "Tag this person" })
                }
              )
            ]
          }
        ),
        /* @__PURE__ */ jsx("button", { className: "group", children: /* @__PURE__ */ jsx("div", { className: "h-3 w-3 border-t-2 border-primary-black opacity-50 border-r-2 relative after:absolute after:w-0.5 after:h-5 after:-right-0.5 after:-top-[1px] after:rotate-45 after:bg-primary-black after:origin-top group-hover:opacity-100 transition-all duration-200 " }) })
      ] })
    ] })
  ] }) });
}
