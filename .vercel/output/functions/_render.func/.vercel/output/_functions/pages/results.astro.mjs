...
import 'kleur/colors';
import { I as InfoCard } from '../chunks/InfoCard_BsxzJxTE.mjs';
import { g as getCreditsPerPerson, $ as $$Layout } from '../chunks/Layout_BOEq5D8r.mjs';
...
function getAllCommonCredits(taggedPeople) {
  ...
  const commonProjects = allFilteredProjects[0].filter(
    (project) => commonProjectIds.has(project.id)
  );
